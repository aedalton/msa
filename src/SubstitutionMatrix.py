...
# Code provided by Prof. Bailey-Kellogg
# COSC 75, Assignment #1
# COSC 75, Final Project, MSA_GA
...
# Added by Katie Lachance & Ali Dalton
# Option for MSA_GA
# Nucleotide exact matrix
nucleotide = SubstitutionMatrix("ACGT", make_identity(4))
